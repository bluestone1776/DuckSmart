...
// Ported from mobile JS to web TypeScript
...
export const IDENTIFY_GROUPS = ["Dabbler", "Diver", "Merganser", "Sea Duck"] as const;
export const IDENTIFY_SIZE = ["Small", "Medium", "Large"] as const;
export const IDENTIFY_HABITATS = ["Timber", "Marsh", "Fields", "Open Water", "Coastline"] as const;

export const IDENTIFY_SPECIES: Species[] = [
  // -- Dabblers -------------------------------------------------------
  {
    id: "mallard",
    name: "Mallard",
  ...
  },
  {
    ...
    tips: [
      "Often found in coastal marshes in the northeast.",
      "Wary \u2014 decoy shy compared to mallards.",
    ],
  ...
  },
  {
    ...
    tips: [
      "Graceful fliers \u2014 long wings, often in V formations.",
      "Pintail limits are often restrictive; know your regulations.",
    ],
  ...
  },
  {
    ...
    tips: [
      "Often grazes on land near water.",
      "Listen for a distinctive 3-note whistle.",
    ],
  ...
  },
  {
    ...
    tips: [
      "Early migrants \u2014 often first teal species seen in early season.",
      "Fly in tight, fast flocks.",
    ],
  ...
  },
  {
    ...
    tips: [
      "Primarily a western species.",
      "Hens are nearly indistinguishable from blue-winged teal hens.",
    ],
  ...
  },
  {
    ...
    tips: [
      "The oversized bill is unmistakable at close range.",
      "Often feed by swimming in circles to stir up food.",
    ],
  ...
  },
  {
    ...
    tips: [
      "Non-migratory; resident along Gulf Coast.",
      "Important to distinguish from mallard hens for accurate reporting.",
    ],
  ...
  },
  {
    ...
    flightInfo: "Strong direct flight; ~50\u201360 mph",
    tips: [
      "Rounder head profile than canvasback.",
      "Often raft with scaup and canvasback.",
    ],
  ...
  },
  {
    ...
    tips: [
      "Should be called 'ring-billed duck' \u2014 bill ring is the key mark.",
      "More likely in smaller ponds than other divers.",
    ],
  ...
  },
  {
    ...
    tips: [
      "Most common scaup inland.",
      "Head peak and thinner white wing stripe help separate from greater.",
    ],
  ...
  },
  {
    ...
    tips: [
      "More coastal than lesser scaup.",
      "Round head and green sheen vs purple in lesser.",
    ],
  ...
  },
  {
    ...
    tips: [
      "Tiny and fast; often patters across water to take flight.",
      "One of the few ducks that can take off without running.",
    ],
  ...
  },
  {
    ...
    tips: [
      "Wings make a distinctive whistling sound.",
      "Often seen in rivers and lakes in winter.",
    ],
  ...
  },
  {
    ...
    tips: [
      ...
      "Crescent face patch vs round spot in common goldeneye.",
    ],
  ...
  // -- Mergansers -----------------------------------------------------
  {
    ...
    tips: [
      "Often in wooded ponds and streams.",
      "Fan crest can be raised or lowered.",
    ],
  ...
  },
  {
    ...
    tips: [
      "Largest merganser; often on large rivers and lakes.",
      "Flies fast and low with direct flight.",
    ],
  ...
  },
  {
    ...
    tips: [
      "Most commonly seen merganser along coastlines.",
      "Shaggy crest is distinctive.",
    ],
  ...
  // -- Sea Ducks ------------------------------------------------------
  {
    ...
    tips: [
      "Deep diver \u2014 can dive to remarkable depths.",
  ...
  },
  {
    ...
    flightInfo: "Fast agile flight; ~50\u201360 mph",
    tips: [
      "Found in fast-moving streams and rocky coastlines.",
      "Beautifully patterned \u2014 a prized sighting.",
    ],
  ...
  },
  {
    ...
    tips: [
      "Most common scoter along both coasts.",
      "Flocks fly low over ocean surf in lines.",
    ],
  ...
  },
  {
    ...
    tips: [
      "White wing patches flash in flight \u2014 key identifier.",
      "Often mixed in with other scoter species.",
    ],
  ...
  },
  {
    ...
    flightInfo: "Fast low flight; ~55\u201365 mph",
    tips: [
      "Orange bill knob is the key field mark on drakes.",
      "Wings produce a whistling sound in flight.",
    ],
  ...
  },
  {
    ...
    tips: [
      "Bulky, heavy body \u2014 unmistakable at close range.",
      "Often found in large rafts along rocky coastlines.",
    ],
...
export const EASTER_EGG_DUCK: Species = {
  id: "probably_a_duck",
...
export const FREE_SPECIES_IDS: string[] = [
  "mallard",
  "blue_winged_teal",
  "green_winged_teal",
  "wood_duck",
...
export const HABITAT_SCORES: Record<string, number> = { High: 4, Medium: 2, Low: 1, Rare: 0 };
 ...
 */
export function computeIdentifyMatches({ group, habitat, size, queryText }: MatchFilter) {
